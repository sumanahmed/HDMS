                                ...
                                <div class="uk-grid" id="testBody" style="display:none;" >
                                    <div class="uk-width-medium-1-1">
                                        <table class="uk-table">
                                            ...
                                            <tr class="test_row_0">
                                                <td>
                                                    <select id="test_category_id_0" class="test_category_list form-control" name="test_category_id[0]" required>
                                                        <option selected disabled>Select</option>
                                    ...
                                    <div class="uk-width-medium-1-1">
                                        <table class="uk-table">
                                            ...
                                            <tr class="prescription_row_0">
                                                ...
                                                <td>
                                                    <select id="taking_time_0" name="taking_time[]" class="form-control">
    ...
    <script>
        ...
        $(".add_prescription_row").click(function () {
            ...
            $(".show_prescription_row").append('' +
                ...
                '   </td>\n' +
                '   <td>\n' +
                '     <select id="taking_time_'+ i +'" name="taking_time[]" class="form-control">\n' +
                '         \n' +
                '      </select>\n' +
                '   </td>\n' +
                '   <td>\n' +
        ...
        function selectMedicineType(index) {
            ...
            if(medicine_type_id){
                ...
                $.get('/prescription/medicine-taking-schedule/'+ medicine_type_id, function(data){
                    ...
                    $("#taking_time_"+index).empty();
                    $("#taking_time_"+index).append('<option selected disabled value="">Select</option>');
                    for(var i =0; i< data.length; i++){
                        $("#taking_time_"+index).append( ' <option value="'+data[i].serial+'">' + data[i].schedule + '</option> ' );
                    }
                });
            }
        }
