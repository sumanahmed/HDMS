                                ...
                                <div class="uk-grid" id="testBody" style="display:none;" >
                                    <div class="uk-width-medium-1-1">
                                        <table class="uk-table">
                                            ...
                                            <tr class="test_row_0">
                                                <td>
                                                    <select id="test_category_id_0" class="test_category_list" name="test_category_id[0]" required>
                                                        <option selected disabled>Select</option>
...
@section('script')
    ...
    <script>
        ...
        $(".test_category_add_row").click(function () {
            ...
            $(".show_test_category_row").append('' +
                ...
                '   <td>\n' +
                '       <select id="test_category_id_'+i+'" class="test_category_list" name="test_category_id[]" required>\n' +
                '           <option selected disabled>Select</option>\n'+
                '           @foreach($test_category as $category)\n' +
                '               <option value="{{ $category->id }}">{{ $category->name }}</option>\n' +
                '           @endforeach\n' +
    ...
    <script>
        $('#sidebar_test_setting').addClass('current_section');
