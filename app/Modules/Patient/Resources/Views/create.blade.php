                                    ...
                                    <div class="uk-width-medium-1-1">
                                        ...
                                        <div class="uk-grid" data-uk-grid-margin>
                                            ...
                                            <div class="uk-width-medium-1-2">
                                                ...
                                                <input class="md-input" type="text" id="admission_date" name="admission_date" value="{{ Carbon\Carbon::now()->format('Y-m-d') }}" data-uk-datepicker="{format:'YYYY-MM-DD'}" required>
